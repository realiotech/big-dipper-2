...
export type EvmBalancesQueryVariables = Exact<{
  address?: InputMaybe<Scalars['String']>;
}>;


export type EvmBalancesQuery = { erc20Balances: Array<{ __typename?: 'ERC20Balance', value: any, contract: { __typename?: 'ERC20Contract', id: any } }> };
...
export const EvmBalancesDocument = gql`
    query EvmBalances($address: String) {
...
/**
 * __useEvmBalancesQuery__
 *
 * To run a query within a React component, call `useEvmBalancesQuery` and pass it any options that fit your needs.
 * When your component renders, `useEvmBalancesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useEvmBalancesQuery({
 *   variables: {
 *      address: // value for 'address'
 *   },
 * });
 */
export function useEvmBalancesQuery(baseOptions?: Apollo.QueryHookOptions<EvmBalancesQuery, EvmBalancesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<EvmBalancesQuery, EvmBalancesQueryVariables>(EvmBalancesDocument, options);
      }
export function useEvmBalancesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EvmBalancesQuery, EvmBalancesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<EvmBalancesQuery, EvmBalancesQueryVariables>(EvmBalancesDocument, options);
        }
export type EvmBalancesQueryHookResult = ReturnType<typeof useEvmBalancesQuery>;
export type EvmBalancesLazyQueryHookResult = ReturnType<typeof useEvmBalancesLazyQuery>;
export type EvmBalancesQueryResult = Apollo.QueryResult<EvmBalancesQuery, EvmBalancesQueryVariables>;