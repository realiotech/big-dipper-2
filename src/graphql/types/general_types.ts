...
export type ActionProposalVotesResponse = {
  __typename?: 'ActionProposalVotesResponse';
  pagination?: Maybe<Scalars['ActionPagination']>;
  votes?: Maybe<Array<Maybe<Scalars['ActionVote']>>>;
};
...
/** Boolean expression to filter rows from the logical model for "amount". All fields are combined with a logical 'AND'. */
export type Amount_Bool_Exp_Bool_Exp = {
  _and?: InputMaybe<Array<Amount_Bool_Exp_Bool_Exp>>;
  _not?: InputMaybe<Amount_Bool_Exp_Bool_Exp>;
  _or?: InputMaybe<Array<Amount_Bool_Exp_Bool_Exp>>;
  amount?: InputMaybe<String_Comparison_Exp>;
};

export enum Amount_Enum_Name {
  /** column name */
  Amount = 'amount'
}

/** Ordering options when selecting data from "amount". */
export type Amount_Order_By = {
...
export enum Balance_Constraint {
  /** unique or primary key constraint on columns "address", "denom" */
...
/** columns and relationships of "bridge_in" */
export type Bridge_In = {
  __typename?: 'bridge_in';
  amount?: Maybe<Scalars['String']>;
  denom?: Maybe<Scalars['String']>;
  hash: Scalars['String'];
...
/** aggregated selection of "bridge_in" */
export type Bridge_In_Aggregate = {
  __typename?: 'bridge_in_aggregate';
  aggregate?: Maybe<Bridge_In_Aggregate_Fields>;
  nodes: Array<Bridge_In>;
};

/** aggregate fields of "bridge_in" */
export type Bridge_In_Aggregate_Fields = {
  __typename?: 'bridge_in_aggregate_fields';
  count: Scalars['Int'];
  max?: Maybe<Bridge_In_Max_Fields>;
  min?: Maybe<Bridge_In_Min_Fields>;
};


/** aggregate fields of "bridge_in" */
export type Bridge_In_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Bridge_In_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
};

/** Boolean expression to filter rows from the table "bridge_in". All fields are combined with a logical 'AND'. */
export type Bridge_In_Bool_Exp = {
  _and?: InputMaybe<Array<Bridge_In_Bool_Exp>>;
  _not?: InputMaybe<Bridge_In_Bool_Exp>;
  _or?: InputMaybe<Array<Bridge_In_Bool_Exp>>;
  amount?: InputMaybe<String_Comparison_Exp>;
  denom?: InputMaybe<String_Comparison_Exp>;
  hash?: InputMaybe<String_Comparison_Exp>;
...
/** unique or primary key constraints on table "bridge_in" */
export enum Bridge_In_Constraint {
  /** unique or primary key constraint on columns "hash" */
  BridgeInPkey = 'bridge_in_pkey'
}

/** input type for inserting data into table "bridge_in" */
export type Bridge_In_Insert_Input = {
  amount?: InputMaybe<Scalars['String']>;
  denom?: InputMaybe<Scalars['String']>;
  hash?: InputMaybe<Scalars['String']>;
...
/** aggregate max on columns */
export type Bridge_In_Max_Fields = {
  __typename?: 'bridge_in_max_fields';
  amount?: Maybe<Scalars['String']>;
  denom?: Maybe<Scalars['String']>;
  hash?: Maybe<Scalars['String']>;
  receiver?: Maybe<Scalars['String']>;
...
/** aggregate min on columns */
export type Bridge_In_Min_Fields = {
  __typename?: 'bridge_in_min_fields';
  amount?: Maybe<Scalars['String']>;
  denom?: Maybe<Scalars['String']>;
  hash?: Maybe<Scalars['String']>;
  receiver?: Maybe<Scalars['String']>;
...
/** response of any mutation on the table "bridge_in" */
export type Bridge_In_Mutation_Response = {
  __typename?: 'bridge_in_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Bridge_In>;
};

/** on_conflict condition type for table "bridge_in" */
export type Bridge_In_On_Conflict = {
  constraint: Bridge_In_Constraint;
  update_columns?: Array<Bridge_In_Update_Column>;
  where?: InputMaybe<Bridge_In_Bool_Exp>;
};

/** Ordering options when selecting data from "bridge_in". */
export type Bridge_In_Order_By = {
  amount?: InputMaybe<Order_By>;
  denom?: InputMaybe<Order_By>;
  hash?: InputMaybe<Order_By>;
...
/** primary key columns input for table: bridge_in */
export type Bridge_In_Pk_Columns_Input = {
  hash: Scalars['String'];
};

/** select columns of table "bridge_in" */
export enum Bridge_In_Select_Column {
  /** column name */
  Amount = 'amount',
  /** column name */
  Denom = 'denom',
...
/** input type for updating data in table "bridge_in" */
export type Bridge_In_Set_Input = {
  amount?: InputMaybe<Scalars['String']>;
  denom?: InputMaybe<Scalars['String']>;
  hash?: InputMaybe<Scalars['String']>;
  receiver?: InputMaybe<Scalars['String']>;
...
/** Streaming cursor of the table "bridge_in" */
export type Bridge_In_Stream_Cursor_Input = {
  /** Stream column input with initial value */
  initial_value: Bridge_In_Stream_Cursor_Value_Input;
  /** cursor ordering */
  ordering?: InputMaybe<Cursor_Ordering>;
};

/** Initial value of the column from where the streaming should start */
export type Bridge_In_Stream_Cursor_Value_Input = {
  amount?: InputMaybe<Scalars['String']>;
  denom?: InputMaybe<Scalars['String']>;
  hash?: InputMaybe<Scalars['String']>;
  receiver?: InputMaybe<Scalars['String']>;
...
/** update columns of table "bridge_in" */
export enum Bridge_In_Update_Column {
  /** column name */
  Amount = 'amount',
  /** column name */
  Denom = 'denom',
...
export type Bridge_In_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Bridge_In_Set_Input>;
  /** filter the rows which have to be updated */
  where: Bridge_In_Bool_Exp;
};

/** columns and relationships of "bridge_out" */
export type Bridge_Out = {
  __typename?: 'bridge_out';
  amount?: Maybe<Scalars['String']>;
  denom?: Maybe<Scalars['String']>;
  hash: Scalars['String'];
...
/** aggregated selection of "bridge_out" */
export type Bridge_Out_Aggregate = {
  __typename?: 'bridge_out_aggregate';
  aggregate?: Maybe<Bridge_Out_Aggregate_Fields>;
  nodes: Array<Bridge_Out>;
};

/** aggregate fields of "bridge_out" */
export type Bridge_Out_Aggregate_Fields = {
  __typename?: 'bridge_out_aggregate_fields';
  count: Scalars['Int'];
  max?: Maybe<Bridge_Out_Max_Fields>;
  min?: Maybe<Bridge_Out_Min_Fields>;
};


/** aggregate fields of "bridge_out" */
export type Bridge_Out_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Bridge_Out_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
};

/** Boolean expression to filter rows from the table "bridge_out". All fields are combined with a logical 'AND'. */
export type Bridge_Out_Bool_Exp = {
  _and?: InputMaybe<Array<Bridge_Out_Bool_Exp>>;
  _not?: InputMaybe<Bridge_Out_Bool_Exp>;
  _or?: InputMaybe<Array<Bridge_Out_Bool_Exp>>;
  amount?: InputMaybe<String_Comparison_Exp>;
  denom?: InputMaybe<String_Comparison_Exp>;
  hash?: InputMaybe<String_Comparison_Exp>;
...
/** unique or primary key constraints on table "bridge_out" */
export enum Bridge_Out_Constraint {
  /** unique or primary key constraint on columns "hash" */
  BridgeOutPkey = 'bridge_out_pkey'
}

/** input type for inserting data into table "bridge_out" */
export type Bridge_Out_Insert_Input = {
  amount?: InputMaybe<Scalars['String']>;
  denom?: InputMaybe<Scalars['String']>;
  hash?: InputMaybe<Scalars['String']>;
...
/** aggregate max on columns */
export type Bridge_Out_Max_Fields = {
  __typename?: 'bridge_out_max_fields';
  amount?: Maybe<Scalars['String']>;
  denom?: Maybe<Scalars['String']>;
  hash?: Maybe<Scalars['String']>;
  sender?: Maybe<Scalars['String']>;
...
/** aggregate min on columns */
export type Bridge_Out_Min_Fields = {
  __typename?: 'bridge_out_min_fields';
  amount?: Maybe<Scalars['String']>;
  denom?: Maybe<Scalars['String']>;
  hash?: Maybe<Scalars['String']>;
  sender?: Maybe<Scalars['String']>;
...
/** response of any mutation on the table "bridge_out" */
export type Bridge_Out_Mutation_Response = {
  __typename?: 'bridge_out_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Bridge_Out>;
};

/** on_conflict condition type for table "bridge_out" */
export type Bridge_Out_On_Conflict = {
  constraint: Bridge_Out_Constraint;
  update_columns?: Array<Bridge_Out_Update_Column>;
  where?: InputMaybe<Bridge_Out_Bool_Exp>;
};

/** Ordering options when selecting data from "bridge_out". */
export type Bridge_Out_Order_By = {
  amount?: InputMaybe<Order_By>;
  denom?: InputMaybe<Order_By>;
  hash?: InputMaybe<Order_By>;
...
/** primary key columns input for table: bridge_out */
export type Bridge_Out_Pk_Columns_Input = {
  hash: Scalars['String'];
};

/** select columns of table "bridge_out" */
export enum Bridge_Out_Select_Column {
  /** column name */
  Amount = 'amount',
  /** column name */
  Denom = 'denom',
...
/** input type for updating data in table "bridge_out" */
export type Bridge_Out_Set_Input = {
  amount?: InputMaybe<Scalars['String']>;
  denom?: InputMaybe<Scalars['String']>;
  hash?: InputMaybe<Scalars['String']>;
  sender?: InputMaybe<Scalars['String']>;
...
/** Streaming cursor of the table "bridge_out" */
export type Bridge_Out_Stream_Cursor_Input = {
  /** Stream column input with initial value */
  initial_value: Bridge_Out_Stream_Cursor_Value_Input;
  /** cursor ordering */
  ordering?: InputMaybe<Cursor_Ordering>;
};

/** Initial value of the column from where the streaming should start */
export type Bridge_Out_Stream_Cursor_Value_Input = {
  amount?: InputMaybe<Scalars['String']>;
  denom?: InputMaybe<Scalars['String']>;
  hash?: InputMaybe<Scalars['String']>;
  sender?: InputMaybe<Scalars['String']>;
...
/** update columns of table "bridge_out" */
export enum Bridge_Out_Update_Column {
  /** column name */
  Amount = 'amount',
  /** column name */
  Denom = 'denom',
...
export type Bridge_Out_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Bridge_Out_Set_Input>;
  /** filter the rows which have to be updated */
  where: Bridge_Out_Bool_Exp;
};
...
/** Boolean expression to filter rows from the logical model for "count". All fields are combined with a logical 'AND'. */
export type Count_Bool_Exp_Bool_Exp = {
  _and?: InputMaybe<Array<Count_Bool_Exp_Bool_Exp>>;
  _not?: InputMaybe<Count_Bool_Exp_Bool_Exp>;
  _or?: InputMaybe<Array<Count_Bool_Exp_Bool_Exp>>;
  count?: InputMaybe<Bigint_Comparison_Exp>;
};

export enum Count_Enum_Name {
  /** column name */
  Count = 'count'
}
...
/** columns and relationships of "etransaction" */
export type Etransaction = {
  __typename?: 'etransaction';
  ehash?: Maybe<Scalars['String']>;
...
/** aggregated selection of "etransaction" */
export type Etransaction_Aggregate = {
  __typename?: 'etransaction_aggregate';
  aggregate?: Maybe<Etransaction_Aggregate_Fields>;
  nodes: Array<Etransaction>;
};

/** aggregate fields of "etransaction" */
export type Etransaction_Aggregate_Fields = {
  __typename?: 'etransaction_aggregate_fields';
  avg?: Maybe<Etransaction_Avg_Fields>;
  count: Scalars['Int'];
  max?: Maybe<Etransaction_Max_Fields>;
  min?: Maybe<Etransaction_Min_Fields>;
  stddev?: Maybe<Etransaction_Stddev_Fields>;
  stddev_pop?: Maybe<Etransaction_Stddev_Pop_Fields>;
  stddev_samp?: Maybe<Etransaction_Stddev_Samp_Fields>;
  sum?: Maybe<Etransaction_Sum_Fields>;
  var_pop?: Maybe<Etransaction_Var_Pop_Fields>;
  var_samp?: Maybe<Etransaction_Var_Samp_Fields>;
  variance?: Maybe<Etransaction_Variance_Fields>;
};


/** aggregate fields of "etransaction" */
export type Etransaction_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Etransaction_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
};

/** aggregate avg on columns */
export type Etransaction_Avg_Fields = {
  __typename?: 'etransaction_avg_fields';
  partition_id?: Maybe<Scalars['Float']>;
};

/** Boolean expression to filter rows from the table "etransaction". All fields are combined with a logical 'AND'. */
export type Etransaction_Bool_Exp = {
  _and?: InputMaybe<Array<Etransaction_Bool_Exp>>;
  _not?: InputMaybe<Etransaction_Bool_Exp>;
  _or?: InputMaybe<Array<Etransaction_Bool_Exp>>;
  ehash?: InputMaybe<String_Comparison_Exp>;
  partition_id?: InputMaybe<Bigint_Comparison_Exp>;
  transaction?: InputMaybe<Transaction_Bool_Exp>;
  transaction_hash?: InputMaybe<String_Comparison_Exp>;
};

/** unique or primary key constraints on table "etransaction" */
export enum Etransaction_Constraint {
  /** unique or primary key constraint on columns "ehash", "partition_id" */
  UniqueEhashPerTx = 'unique_ehash_per_tx'
}

/** input type for incrementing numeric columns in table "etransaction" */
export type Etransaction_Inc_Input = {
  partition_id?: InputMaybe<Scalars['bigint']>;
};

/** input type for inserting data into table "etransaction" */
export type Etransaction_Insert_Input = {
  ehash?: InputMaybe<Scalars['String']>;
  partition_id?: InputMaybe<Scalars['bigint']>;
...
/** aggregate max on columns */
export type Etransaction_Max_Fields = {
  __typename?: 'etransaction_max_fields';
  ehash?: Maybe<Scalars['String']>;
...
/** aggregate min on columns */
export type Etransaction_Min_Fields = {
  __typename?: 'etransaction_min_fields';
  ehash?: Maybe<Scalars['String']>;
  partition_id?: Maybe<Scalars['bigint']>;
  transaction_hash?: Maybe<Scalars['String']>;
};

/** response of any mutation on the table "etransaction" */
export type Etransaction_Mutation_Response = {
  __typename?: 'etransaction_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Etransaction>;
};

/** on_conflict condition type for table "etransaction" */
export type Etransaction_On_Conflict = {
  constraint: Etransaction_Constraint;
  update_columns?: Array<Etransaction_Update_Column>;
  where?: InputMaybe<Etransaction_Bool_Exp>;
};

/** Ordering options when selecting data from "etransaction". */
export type Etransaction_Order_By = {
  ehash?: InputMaybe<Order_By>;
  partition_id?: InputMaybe<Order_By>;
  transaction?: InputMaybe<Transaction_Order_By>;
  transaction_hash?: InputMaybe<Order_By>;
};

/** select columns of table "etransaction" */
export enum Etransaction_Select_Column {
  /** column name */
  Ehash = 'ehash',
  /** column name */
...
/** input type for updating data in table "etransaction" */
export type Etransaction_Set_Input = {
  ehash?: InputMaybe<Scalars['String']>;
  partition_id?: InputMaybe<Scalars['bigint']>;
  transaction_hash?: InputMaybe<Scalars['String']>;
};
...
/** aggregate stddev on columns */
export type Etransaction_Stddev_Fields = {
  __typename?: 'etransaction_stddev_fields';
  partition_id?: Maybe<Scalars['Float']>;
};

/** aggregate stddev_pop on columns */
export type Etransaction_Stddev_Pop_Fields = {
  __typename?: 'etransaction_stddev_pop_fields';
  partition_id?: Maybe<Scalars['Float']>;
};

/** aggregate stddev_samp on columns */
export type Etransaction_Stddev_Samp_Fields = {
  __typename?: 'etransaction_stddev_samp_fields';
  partition_id?: Maybe<Scalars['Float']>;
};

/** Streaming cursor of the table "etransaction" */
export type Etransaction_Stream_Cursor_Input = {
  /** Stream column input with initial value */
  initial_value: Etransaction_Stream_Cursor_Value_Input;
  /** cursor ordering */
  ordering?: InputMaybe<Cursor_Ordering>;
};

/** Initial value of the column from where the streaming should start */
export type Etransaction_Stream_Cursor_Value_Input = {
  ehash?: InputMaybe<Scalars['String']>;
  partition_id?: InputMaybe<Scalars['bigint']>;
  transaction_hash?: InputMaybe<Scalars['String']>;
};
...
/** aggregate sum on columns */
export type Etransaction_Sum_Fields = {
  __typename?: 'etransaction_sum_fields';
  partition_id?: Maybe<Scalars['bigint']>;
};

/** update columns of table "etransaction" */
export enum Etransaction_Update_Column {
  /** column name */
  Ehash = 'ehash',
  /** column name */
  PartitionId = 'partition_id',
...
export type Etransaction_Updates = {
  /** increments the numeric columns with given value of the filtered values */
  _inc?: InputMaybe<Etransaction_Inc_Input>;
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Etransaction_Set_Input>;
  /** filter the rows which have to be updated */
  where: Etransaction_Bool_Exp;
};

/** aggregate var_pop on columns */
export type Etransaction_Var_Pop_Fields = {
  __typename?: 'etransaction_var_pop_fields';
  partition_id?: Maybe<Scalars['Float']>;
};

/** aggregate var_samp on columns */
export type Etransaction_Var_Samp_Fields = {
  __typename?: 'etransaction_var_samp_fields';
  partition_id?: Maybe<Scalars['Float']>;
};

/** aggregate variance on columns */
export type Etransaction_Variance_Fields = {
  __typename?: 'etransaction_variance_fields';
  partition_id?: Maybe<Scalars['Float']>;
};
...
/** locks_count_by_delNative Query Arguments */
export type Locks_Count_By_Del_Arguments = {
  /** Native Query argument address */
  address: Scalars['String'];
};

/** locks_count_by_denomNative Query Arguments */
export type Locks_Count_By_Denom_Arguments = {
  /** Native Query argument denom */
  denom: Scalars['String'];
};

/** locks_count_by_valNative Query Arguments */
export type Locks_Count_By_Val_Arguments = {
  /** Native Query argument address */
  address: Scalars['String'];
};
...
export type Ms_Locks = {
  __typename?: 'ms_locks';
  amount?: Maybe<Scalars['String']>;
  bond_weight?: Maybe<Scalars['String']>;
  denom?: Maybe<Scalars['String']>;
  height: Scalars['bigint'];
...
export type Ms_Locks_Bool_Exp = {
  ...
  amount?: InputMaybe<String_Comparison_Exp>;
  bond_weight?: InputMaybe<String_Comparison_Exp>;
  denom?: InputMaybe<String_Comparison_Exp>;
  height?: InputMaybe<Bigint_Comparison_Exp>;
...
export type Ms_Locks_Insert_Input = {
  amount?: InputMaybe<Scalars['String']>;
  bond_weight?: InputMaybe<Scalars['String']>;
  denom?: InputMaybe<Scalars['String']>;
  height?: InputMaybe<Scalars['bigint']>;
...
export type Ms_Locks_Order_By = {
  amount?: InputMaybe<Order_By>;
  bond_weight?: InputMaybe<Order_By>;
  denom?: InputMaybe<Order_By>;
  height?: InputMaybe<Order_By>;
...
export type Ms_Unlocks_Avg_Fields = {
  ...
  creation_height?: Maybe<Scalars['Float']>;
  height?: Maybe<Scalars['Float']>;
};
...
export type Ms_Unlocks_Bool_Exp = {
  ...
  amount?: InputMaybe<String_Comparison_Exp>;
  bond_weight?: InputMaybe<String_Comparison_Exp>;
  creation_height?: InputMaybe<Bigint_Comparison_Exp>;
  denom?: InputMaybe<String_Comparison_Exp>;
  height?: InputMaybe<Bigint_Comparison_Exp>;
  staker_addr?: InputMaybe<String_Comparison_Exp>;
  val_addr?: InputMaybe<String_Comparison_Exp>;
...
export type Ms_Unlocks_Inc_Input = {
  creation_height?: InputMaybe<Scalars['bigint']>;
  height?: InputMaybe<Scalars['bigint']>;
};
...
export type Ms_Unlocks_Max_Fields = {
  ...
  amount?: Maybe<Scalars['String']>;
  bond_weight?: Maybe<Scalars['String']>;
  creation_height?: Maybe<Scalars['bigint']>;
  denom?: Maybe<Scalars['String']>;
  height?: Maybe<Scalars['bigint']>;
  staker_addr?: Maybe<Scalars['String']>;
  val_addr?: Maybe<Scalars['String']>;
...
export type Ms_Unlocks_Order_By = {
  amount?: InputMaybe<Order_By>;
  bond_weight?: InputMaybe<Order_By>;
  creation_height?: InputMaybe<Order_By>;
  denom?: InputMaybe<Order_By>;
  height?: InputMaybe<Order_By>;
  staker_addr?: InputMaybe<Order_By>;
  val_addr?: InputMaybe<Order_By>;
...
export type Mutation_Root = {
  ...
  /** delete data from the table: "bridge_in" */
  delete_bridge_in?: Maybe<Bridge_In_Mutation_Response>;
  /** delete single row from the table: "bridge_in" */
  delete_bridge_in_by_pk?: Maybe<Bridge_In>;
  /** delete data from the table: "bridge_out" */
  delete_bridge_out?: Maybe<Bridge_Out_Mutation_Response>;
  /** delete single row from the table: "bridge_out" */
  delete_bridge_out_by_pk?: Maybe<Bridge_Out>;
  ...
  /** delete data from the table: "etransaction" */
  delete_etransaction?: Maybe<Etransaction_Mutation_Response>;
  ...
  /** insert data into the table: "bridge_in" */
  insert_bridge_in?: Maybe<Bridge_In_Mutation_Response>;
  /** insert a single row into the table: "bridge_in" */
  insert_bridge_in_one?: Maybe<Bridge_In>;
  /** insert data into the table: "bridge_out" */
  insert_bridge_out?: Maybe<Bridge_Out_Mutation_Response>;
  /** insert a single row into the table: "bridge_out" */
  insert_bridge_out_one?: Maybe<Bridge_Out>;
  ...
  /** insert data into the table: "etransaction" */
  insert_etransaction?: Maybe<Etransaction_Mutation_Response>;
  /** insert a single row into the table: "etransaction" */
  insert_etransaction_one?: Maybe<Etransaction>;
  ...
  /** update data of the table: "bridge_in" */
  update_bridge_in?: Maybe<Bridge_In_Mutation_Response>;
  /** update single row of the table: "bridge_in" */
  update_bridge_in_by_pk?: Maybe<Bridge_In>;
  /** update multiples rows of table: "bridge_in" */
  update_bridge_in_many?: Maybe<Array<Maybe<Bridge_In_Mutation_Response>>>;
  /** update data of the table: "bridge_out" */
  update_bridge_out?: Maybe<Bridge_Out_Mutation_Response>;
  /** update single row of the table: "bridge_out" */
  update_bridge_out_by_pk?: Maybe<Bridge_Out>;
  /** update multiples rows of table: "bridge_out" */
  update_bridge_out_many?: Maybe<Array<Maybe<Bridge_Out_Mutation_Response>>>;
  ...
  /** update data of the table: "etransaction" */
  update_etransaction?: Maybe<Etransaction_Mutation_Response>;
  /** update multiples rows of table: "etransaction" */
  update_etransaction_many?: Maybe<Array<Maybe<Etransaction_Mutation_Response>>>;
...
/** mutation root */
export type Mutation_RootDelete_Bridge_InArgs = {
  where: Bridge_In_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Bridge_In_By_PkArgs = {
  hash: Scalars['String'];
};


/** mutation root */
export type Mutation_RootDelete_Bridge_OutArgs = {
  where: Bridge_Out_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Bridge_Out_By_PkArgs = {
  hash: Scalars['String'];
};
...
/** mutation root */
export type Mutation_RootDelete_EtransactionArgs = {
  where: Etransaction_Bool_Exp;
};
...
/** mutation root */
export type Mutation_RootInsert_Bridge_InArgs = {
  objects: Array<Bridge_In_Insert_Input>;
  on_conflict?: InputMaybe<Bridge_In_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Bridge_In_OneArgs = {
  object: Bridge_In_Insert_Input;
  on_conflict?: InputMaybe<Bridge_In_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Bridge_OutArgs = {
  objects: Array<Bridge_Out_Insert_Input>;
  on_conflict?: InputMaybe<Bridge_Out_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Bridge_Out_OneArgs = {
  object: Bridge_Out_Insert_Input;
  on_conflict?: InputMaybe<Bridge_Out_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootInsert_EtransactionArgs = {
  objects: Array<Etransaction_Insert_Input>;
  on_conflict?: InputMaybe<Etransaction_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Etransaction_OneArgs = {
  object: Etransaction_Insert_Input;
  on_conflict?: InputMaybe<Etransaction_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Bridge_InArgs = {
  _set?: InputMaybe<Bridge_In_Set_Input>;
  where: Bridge_In_Bool_Exp;
};
...
/** mutation root */
export type Mutation_RootUpdate_Bridge_In_By_PkArgs = {
  _set?: InputMaybe<Bridge_In_Set_Input>;
  pk_columns: Bridge_In_Pk_Columns_Input;
};


/** mutation root */
export type Mutation_RootUpdate_Bridge_In_ManyArgs = {
  updates: Array<Bridge_In_Updates>;
};


/** mutation root */
export type Mutation_RootUpdate_Bridge_OutArgs = {
  _set?: InputMaybe<Bridge_Out_Set_Input>;
  where: Bridge_Out_Bool_Exp;
};
...
/** mutation root */
export type Mutation_RootUpdate_Bridge_Out_By_PkArgs = {
  _set?: InputMaybe<Bridge_Out_Set_Input>;
  pk_columns: Bridge_Out_Pk_Columns_Input;
};


/** mutation root */
export type Mutation_RootUpdate_Bridge_Out_ManyArgs = {
  updates: Array<Bridge_Out_Updates>;
};
...
/** mutation root */
export type Mutation_RootUpdate_EtransactionArgs = {
  _inc?: InputMaybe<Etransaction_Inc_Input>;
  _set?: InputMaybe<Etransaction_Set_Input>;
  where: Etransaction_Bool_Exp;
};
...
/** mutation root */
export type Mutation_RootUpdate_Etransaction_ManyArgs = {
  updates: Array<Etransaction_Updates>;
};
...
export type Query_Root = {
  ...
  action_proposal_votes?: Maybe<ActionProposalVotesResponse>;
  ...
  /** fetch data from the table: "bridge_in" */
  bridge_in: Array<Bridge_In>;
  /** fetch aggregated fields from the table: "bridge_in" */
  bridge_in_aggregate: Bridge_In_Aggregate;
  /** fetch data from the table: "bridge_in" using primary key columns */
  bridge_in_by_pk?: Maybe<Bridge_In>;
  /** fetch data from the table: "bridge_out" */
  bridge_out: Array<Bridge_Out>;
  /** fetch aggregated fields from the table: "bridge_out" */
  bridge_out_aggregate: Bridge_Out_Aggregate;
  /** fetch data from the table: "bridge_out" using primary key columns */
  bridge_out_by_pk?: Maybe<Bridge_Out>;
  ...
  /** fetch data from the table: "etransaction" */
  etransaction: Array<Etransaction>;
  /** fetch aggregated fields from the table: "etransaction" */
  etransaction_aggregate: Etransaction_Aggregate;
  ...
  locks_count_by_del: Array<Count>;
  locks_count_by_denom: Array<Count>;
...
export type Query_RootAction_Proposal_VotesArgs = {
  count_total?: InputMaybe<Scalars['Boolean']>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  proposal_id?: InputMaybe<Scalars['Int']>;
...
export type Query_RootBridge_InArgs = {
  distinct_on?: InputMaybe<Array<Bridge_In_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_In_Order_By>>;
  where?: InputMaybe<Bridge_In_Bool_Exp>;
};


export type Query_RootBridge_In_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Bridge_In_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_In_Order_By>>;
...
export type Query_RootBridge_In_By_PkArgs = {
  hash: Scalars['String'];
};


export type Query_RootBridge_OutArgs = {
  distinct_on?: InputMaybe<Array<Bridge_Out_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_Out_Order_By>>;
  where?: InputMaybe<Bridge_Out_Bool_Exp>;
};


export type Query_RootBridge_Out_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Bridge_Out_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_Out_Order_By>>;
...
export type Query_RootBridge_Out_By_PkArgs = {
  hash: Scalars['String'];
};
...
export type Query_RootEtransactionArgs = {
  distinct_on?: InputMaybe<Array<Etransaction_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Etransaction_Order_By>>;
  where?: InputMaybe<Etransaction_Bool_Exp>;
};


export type Query_RootEtransaction_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Etransaction_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Etransaction_Order_By>>;
...
export type Query_RootLocks_Count_By_DelArgs = {
  args: Locks_Count_By_Del_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Count_Order_By>>;
...
export type Query_RootLocks_Count_By_DenomArgs = {
  args: Locks_Count_By_Denom_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Count_Order_By>>;
...
export type Query_RootLocks_Count_By_ValArgs = {
  args: Locks_Count_By_Val_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Count_Order_By>>;
...
export type Query_RootSupply_By_DenomArgs = {
  ...
  distinct_on?: InputMaybe<Array<Amount_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Amount_Order_By>>;
  where?: InputMaybe<Amount_Bool_Exp_Bool_Exp>;
};
...
export type Query_RootUnlocks_Count_By_DelArgs = {
  args: Unlocks_Count_By_Del_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Count_Order_By>>;
...
export type Query_RootUnlocks_Count_By_DenomArgs = {
  args: Unlocks_Count_By_Denom_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Count_Order_By>>;
...
export type Query_RootUnlocks_Count_By_ValArgs = {
  args: Unlocks_Count_By_Val_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Count_Order_By>>;
...
export type Subscription_Root = {
  ...
  /** fetch data from the table: "bridge_in" using primary key columns */
  bridge_in_by_pk?: Maybe<Bridge_In>;
  /** fetch data from the table in a streaming manner: "bridge_in" */
  bridge_in_stream: Array<Bridge_In>;
  /** fetch data from the table: "bridge_out" */
  bridge_out: Array<Bridge_Out>;
  /** fetch aggregated fields from the table: "bridge_out" */
  bridge_out_aggregate: Bridge_Out_Aggregate;
  /** fetch data from the table: "bridge_out" using primary key columns */
  bridge_out_by_pk?: Maybe<Bridge_Out>;
  /** fetch data from the table in a streaming manner: "bridge_out" */
  bridge_out_stream: Array<Bridge_Out>;
  /** fetch data from the table: "community_pool" */
  community_pool: Array<Community_Pool>;
  /** fetch aggregated fields from the table: "community_pool" */
  community_pool_aggregate: Community_Pool_Aggregate;
  ...
  /** fetch aggregated fields from the table: "etransaction" */
  etransaction_aggregate: Etransaction_Aggregate;
  /** fetch data from the table in a streaming manner: "etransaction" */
  etransaction_stream: Array<Etransaction>;
  /** fetch data from the table: "fee_grant_allowance" */
  fee_grant_allowance: Array<Fee_Grant_Allowance>;
  /** fetch aggregated fields from the table: "fee_grant_allowance" */
  fee_grant_allowance_aggregate: Fee_Grant_Allowance_Aggregate;
...
export type Subscription_RootBridge_InArgs = {
  distinct_on?: InputMaybe<Array<Bridge_In_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_In_Order_By>>;
...
export type Subscription_RootBridge_In_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Bridge_In_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_In_Order_By>>;
...
export type Subscription_RootBridge_In_By_PkArgs = {
  hash: Scalars['String'];
};


export type Subscription_RootBridge_In_StreamArgs = {
  batch_size: Scalars['Int'];
  cursor: Array<InputMaybe<Bridge_In_Stream_Cursor_Input>>;
  where?: InputMaybe<Bridge_In_Bool_Exp>;
};


export type Subscription_RootBridge_OutArgs = {
  distinct_on?: InputMaybe<Array<Bridge_Out_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_Out_Order_By>>;
...
export type Subscription_RootBridge_Out_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Bridge_Out_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Bridge_Out_Order_By>>;
...
export type Subscription_RootBridge_Out_By_PkArgs = {
  hash: Scalars['String'];
};


export type Subscription_RootBridge_Out_StreamArgs = {
  batch_size: Scalars['Int'];
  cursor: Array<InputMaybe<Bridge_Out_Stream_Cursor_Input>>;
  where?: InputMaybe<Bridge_Out_Bool_Exp>;
};
...
export type Subscription_RootEtransactionArgs = {
  distinct_on?: InputMaybe<Array<Etransaction_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Etransaction_Order_By>>;
...
export type Subscription_RootEtransaction_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Etransaction_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Etransaction_Order_By>>;
...
export type Subscription_RootEtransaction_StreamArgs = {
  batch_size: Scalars['Int'];
  cursor: Array<InputMaybe<Etransaction_Stream_Cursor_Input>>;
  where?: InputMaybe<Etransaction_Bool_Exp>;
};
...
export type Subscription_RootLocks_Count_By_DelArgs = {
  args: Locks_Count_By_Del_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
...
export type Subscription_RootLocks_Count_By_DenomArgs = {
  args: Locks_Count_By_Denom_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
...
export type Subscription_RootLocks_Count_By_ValArgs = {
  args: Locks_Count_By_Val_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
...
export type Subscription_RootUnlocks_Count_By_DelArgs = {
  args: Unlocks_Count_By_Del_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
...
export type Subscription_RootUnlocks_Count_By_DenomArgs = {
  args: Unlocks_Count_By_Denom_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
...
export type Subscription_RootUnlocks_Count_By_ValArgs = {
  args: Unlocks_Count_By_Val_Arguments;
  distinct_on?: InputMaybe<Array<Count_Enum_Name>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
...
/** unlocks_count_by_delNative Query Arguments */
export type Unlocks_Count_By_Del_Arguments = {
  /** Native Query argument address */
  address: Scalars['String'];
};

/** unlocks_count_by_denomNative Query Arguments */
export type Unlocks_Count_By_Denom_Arguments = {
  /** Native Query argument denom */
  denom: Scalars['String'];
};

/** unlocks_count_by_valNative Query Arguments */
export type Unlocks_Count_By_Val_Arguments = {
  /** Native Query argument address */
  address: Scalars['String'];
};
...
export type Validator = {
  ...
  /** An object relationship */
  validator_denom?: Maybe<Validator_Denom>;
  /** An array relationship */
...
export type Validator_Bool_Exp = {
  ...
  validator_denom?: InputMaybe<Validator_Denom_Bool_Exp>;
...
/** input type for inserting object relation for remote table "validator_denom" */
export type Validator_Denom_Obj_Rel_Insert_Input = {
  data: Validator_Denom_Insert_Input;
  /** upsert condition */
  on_conflict?: InputMaybe<Validator_Denom_On_Conflict>;
};
...
export type Validator_Insert_Input = {
  ...
  validator_denom?: InputMaybe<Validator_Denom_Obj_Rel_Insert_Input>;
...
export type Validator_Order_By = {
  ...
  validator_denom?: InputMaybe<Validator_Denom_Order_By>;
...
export type MarketDataQuery = { communityPool: Array<{ __typename?: 'community_pool', coins: Array<any> }>, inflation: Array<{ __typename?: 'mint_params', params: any }> };

export type SuppliesQueryVariables = Exact<{ [key: string]: never; }>;


export type SuppliesQuery = { supply: Array<{ __typename?: 'supply', coins: Array<any> }> };
...
export type TransactionsCountQuery = { txs_count: Array<{ __typename?: 'count', count: any }> };

export type EvmTransactionQueryVariables = Exact<{
  ehash?: InputMaybe<Scalars['String']>;
}>;
...
/**
 * __useAssetDelegationsQuery__
 *
 * To run a query within a React component, call `useAssetDelegationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAssetDelegationsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAssetDelegationsQuery({
 *   variables: {
 *      denom: // value for 'denom'
 *      offset: // value for 'offset'
 *      limit: // value for 'limit'
 ...
 * });
 */
export function useAssetDelegationsQuery(baseOptions: Apollo.QueryHookOptions<AssetDelegationsQuery, AssetDelegationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AssetDelegationsQuery, AssetDelegationsQueryVariables>(AssetDelegationsDocument, options);
      }
export function useAssetDelegationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AssetDelegationsQuery, AssetDelegationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AssetDelegationsQuery, AssetDelegationsQueryVariables>(AssetDelegationsDocument, options);
        }
export type AssetDelegationsQueryHookResult = ReturnType<typeof useAssetDelegationsQuery>;
...
/**
 * __useAssetUndelegationsQuery__
 *
 * To run a query within a React component, call `useAssetUndelegationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAssetUndelegationsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAssetUndelegationsQuery({
 *   variables: {
 *      denom: // value for 'denom'
 *      offset: // value for 'offset'
 *      limit: // value for 'limit'
 ...
 * });
 */
export function useAssetUndelegationsQuery(baseOptions: Apollo.QueryHookOptions<AssetUndelegationsQuery, AssetUndelegationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AssetUndelegationsQuery, AssetUndelegationsQueryVariables>(AssetUndelegationsDocument, options);
      }
export function useAssetUndelegationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AssetUndelegationsQuery, AssetUndelegationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AssetUndelegationsQuery, AssetUndelegationsQueryVariables>(AssetUndelegationsDocument, options);
        }
...
export const SuppliesDocument = gql`
    query Supplies {
  supply {
    coins
  }
...
/**
 * __useSuppliesQuery__
 *
 * To run a query within a React component, call `useSuppliesQuery` and pass it any options that fit your needs.
 * When your component renders, `useSuppliesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSuppliesQuery({
 *   variables: {
 *   },
 * });
 */
export function useSuppliesQuery(baseOptions?: Apollo.QueryHookOptions<SuppliesQuery, SuppliesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SuppliesQuery, SuppliesQueryVariables>(SuppliesDocument, options);
      }
export function useSuppliesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SuppliesQuery, SuppliesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SuppliesQuery, SuppliesQueryVariables>(SuppliesDocument, options);
        }
export type SuppliesQueryHookResult = ReturnType<typeof useSuppliesQuery>;
 ...
 * });
 */
export function useTransactionsCountQuery(baseOptions?: Apollo.QueryHookOptions<TransactionsCountQuery, TransactionsCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionsCountQuery, TransactionsCountQueryVariables>(TransactionsCountDocument, options);
      }
export function useTransactionsCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionsCountQuery, TransactionsCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionsCountQuery, TransactionsCountQueryVariables>(TransactionsCountDocument, options);
        }
...
export const EvmTransactionDocument = gql`
    query EvmTransaction($ehash: String) {
...
/**
 * __useEvmTransactionQuery__
 *
 * To run a query within a React component, call `useEvmTransactionQuery` and pass it any options that fit your needs.
 * When your component renders, `useEvmTransactionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useEvmTransactionQuery({
 *   variables: {
 *      ehash: // value for 'ehash'
 *   },
 * });
 */
export function useEvmTransactionQuery(baseOptions?: Apollo.QueryHookOptions<EvmTransactionQuery, EvmTransactionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<EvmTransactionQuery, EvmTransactionQueryVariables>(EvmTransactionDocument, options);
      }
export function useEvmTransactionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EvmTransactionQuery, EvmTransactionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<EvmTransactionQuery, EvmTransactionQueryVariables>(EvmTransactionDocument, options);
        }
