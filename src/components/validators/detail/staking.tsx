    ...
    >
      ...
      {delegations?.data ? (
        <Box bg={{ base: "#FAFBFC", _dark: "#0F0F0F" }} p={6} borderRadius="md" boxShadow="sm" mb={8}>
          <TabsContent value={1}>
            <Delegations data={delegations} page={delegationsPage} setPage={setDelegationsPage} displayMode={1} handleSort={handleSort} sort={sortDirection} />
          </TabsContent>
          <TabsContent value={2}>
            <Undelegations data={unbondings} page={unbondingsPage} setPage={setUnboningsPage} displayMode={1} handleSort={handleSort} sort={sortDirection} />
          </TabsContent>
        </Box>
      ) : (
        <NoData />
